...
class _EditAlbumState extends State<EditAlbum> {
  ...
  void initState() {
    super.initState();
    this.setState(() {
      albumName.text = widget.editData.title;
      _switchValue = widget.editData.favourite;
    });
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child:
                          Icon(FontAwesomeIcons.solidEdit, color: Colors.white),
                    ),
                  ),
                  SizedBox(
                    height: 20.0,
                      ...
                      onPressed: !loading
                          ? () {
                              editAlbum(
                                      ...
                                      loadingchange)
                                  .then((value) {
                                widget.editCreatedAlbumData(value);
                              });
                            }
                          : null,
                      color: Colors.teal,
