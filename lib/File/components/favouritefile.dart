...
import 'package:fproject/File/components/api_response.dart';
...
class FavouriteFile extends StatefulWidget {
  List<FileModel> data;
  ...
  @override
  _FavouriteFileState createState() => _FavouriteFileState();
}

class _FavouriteFileState extends State<FavouriteFile> {
